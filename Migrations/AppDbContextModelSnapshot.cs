...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManagement_Backend.Models.Billing", b =>
                {
                    ...
                    b.Property<string>("CustomerAadharNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerMobileNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerPassNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FleetManagement_Backend.Models.Billing", b =>
                {
                    b.HasOne("FleetManagement_Backend.Models.Booking", "Booking")
                        .WithMany()
                        .HasForeignKey("BookingId");

                    b.HasOne("FleetManagement_Backend.Models.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId");

                    b.HasOne("FleetManagement_Backend.Models.Hubs", "DropHub")
                        .WithMany()
                        .HasForeignKey("DropHubId");

                    b.HasOne("FleetManagement_Backend.Models.Hubs", "PickupHub")
                        .WithMany()
